...
const DiscountsForm = dynamic(
  () => import('@/components/admin/discounts-form'),
  {
    loading: () => (
        ...
        <>
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Coupon management for {restaurantName}
            </p>
          </div>
          <DiscountsForm
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-12 text-center shadow-sm">
            ...
            <p className="mx-auto max-w-md text-sm text-gray-600">
              Please select a restaurant from the sidebar to manage discounts.
            </p>
          </div>
        </div>
      )}
