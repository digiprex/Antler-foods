...
const LoyaltySettingsForm = dynamic(
  () => import('@/components/admin/loyalty-settings-form'),
  {
    loading: () => (
...
function LoyaltySettingsContent() {
        ...
        <>
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Configure the loyalty rewards program for {restaurantName}
            </p>
          </div>
          <LoyaltySettingsForm
        ...
        <div className="flex min-h-[400px] items-center justify-center">
          <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-12 text-center shadow-sm">
            ...
            <p className="mx-auto max-w-md text-sm text-gray-600">
              Please select a restaurant from the sidebar to manage loyalty settings.
            </p>
          </div>
        </div>
      )}
