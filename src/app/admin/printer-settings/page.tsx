...
const PrinterSettingsForm = dynamic(
  () => import('@/components/admin/printer-settings-form'),
  {
    loading: () => (
      <div className="flex min-h-[300px] items-center justify-center">
        <div className="inline-flex items-center gap-3 rounded-xl border border-purple-200 bg-purple-50 px-5 py-3.5">
          <div className="h-5 w-5 animate-spin rounded-full border-2 border-purple-600 border-t-transparent" />
          <p className="text-sm font-medium text-gray-700">Loading printer settings...</p>
        </div>
      </div>
    ),
    ssr: false,
        ...
        <>
          <div className="mb-6">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Configure printer and auto-print for kitchen order tickets
            </p>
          </div>
          <PrinterSettingsForm
        ...
        <div className="flex min-h-[400px] items-center justify-center">
          <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-12 text-center shadow-sm">
            ...
            <p className="mx-auto max-w-md text-sm text-gray-600">
              Please select a restaurant from the sidebar to manage printer settings.
            </p>
          </div>
        </div>
      )}
