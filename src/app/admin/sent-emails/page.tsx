  ...
  return (
    <DashboardLayout>
      {restaurantId && restaurantName ? (
        <>
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900">Sent & Scheduled Emails</h1>
            <p className="text-sm text-gray-600 mt-1">
              View sent and upcoming scheduled emails for {restaurantName}
            </p>
          </div>
          <SentEmailsForm restaurantId={restaurantId} restaurantName={restaurantName} />
        </>
      ) : (
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-12 text-center shadow-sm">
            ...
            <p className="mx-auto max-w-md text-sm text-gray-600">
              Please select a restaurant to view emails.
            </p>
          </div>
        </div>
      )}
