...
const GET_LOCATION_CONFIG = `
  query GetLocationConfig($restaurant_id: uuid!) {
    templates(
      where: {
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[Location Config] Using restaurant_id:', restaurantId);
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[Location Config] Saving config for restaurant:', restaurant_id);
