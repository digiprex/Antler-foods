  ...
  try {
    ...
    if (!(data as any).templates || (data as any).templates.length === 0) {
      ...
      const defaultConfig: NavbarConfig = {
        ...
        buttonBgColor: globalStyles?.primaryButton?.backgroundColor || '#000000',
    ...
    const config: NavbarConfig = {
      ...
      buttonBgColor: template.config?.buttonBgColor || globalStyles?.primaryButton?.backgroundColor || '#000000',
