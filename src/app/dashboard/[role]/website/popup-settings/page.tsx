      ...
      <div className="flex min-h-[400px] items-center justify-center p-6">
        <div className="max-w-md text-center">
          ...
          <p className="mb-6 text-sm text-gray-600">
            This restaurant doesn't have a website created yet. You need to create a site first before configuring popup settings.
          </p>
          <button
            onClick={() => {
    ...
    <div className="flex items-center justify-center min-h-[400px]">
      <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-12 text-center shadow-sm">
        ...
        <p className="mx-auto max-w-md text-sm text-gray-600">
          Please add or select a restaurant from the sidebar to configure popup settings.
        </p>
      </div>
    </div>
  );
...
export default function RoleWebsitePopupSettingsPage() {
  return (
