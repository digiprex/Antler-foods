        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-600">Configure announcement bar behavior</p>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-600">Manage announcement content and details</p>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-sm text-gray-600">Customize text styling</p>
            </div>
          </div>
