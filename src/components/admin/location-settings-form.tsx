  ...
  return (
    <>
      <form onSubmit={handleSubmit} className={styles.form}>
        ...
        {(loadingPlace || placeDetails) && (
          <div className={styles.section}>
            {loadingPlace ? (
              <div style={{ textAlign: 'center', padding: '2rem' }}>
                <div className={styles.spinner} style={{ margin: '0 auto 1rem' }}></div>
                <p style={{ color: '#6b7280' }}>Loading location details from Google...</p>
              </div>
            ) : placeDetails ? (
              <div>
                  ...
                  <div style={{ display: 'grid', gap: '0.75rem', color: '#6b7280' }}>
                    ...
                    {placeDetails.opening_hours?.weekday_text && (
                      <div style={{ marginTop: '0.5rem' }}>
                        ...
                        <div style={{ paddingLeft: '1.75rem', fontSize: '0.875rem' }}>
...
{/* 
                    <div style={{ marginTop: '0.5rem', padding: '0.75rem', backgroundColor: '#fff', borderRadius: '6px' }}>
                      ...
                      <div style={{ fontSize: '0.875rem', fontFamily: 'monospace' }}>
                        {typeof placeDetails.geometry.location.lat === 'function'
                          ...
                          : placeDetails.geometry.location.lat.toFixed(6)}, {typeof placeDetails.geometry.location.lng === 'function'
                ...
                {/* <div style={{ marginBottom: '1.5rem' }}>
                  ...
                  <div style={{ height: '400px', border: '2px solid #e5e7eb', borderRadius: '8px', overflow: 'hidden' }}>
                    <GoogleLocationPicker
                      location={{
                        ...
                        zipCode: '',
                        country: '',
                        latitude: typeof placeDetails.geometry.location.lat === 'function'
                          ? placeDetails.geometry.location.lat()
                          : placeDetails.geometry.location.lat,
                        longitude: typeof placeDetails.geometry.location.lng === 'function'
                ...
                {/* <div style={{
                  ...
                  <strong>ℹ️ Note:</strong> Location information is automatically fetched from Google Places. To update location details, you need to claim and update your business on Google My Business.
                </div> */}
              </div>
            ) : null}
          </div>
