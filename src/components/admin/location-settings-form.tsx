...
import { LocationLayoutPreview } from '@/components/admin/location-layout-preview';
...
export default function LocationSettingsForm({
  ...
  // Use JSON-based layout preview rendering
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {layoutOptions.map((option) => {
              ...
              return (
                ...
                >
                  <div className="mb-4">
                    <LocationLayoutPreview layoutValue={option.value} active={isActive} />
                  </div>
