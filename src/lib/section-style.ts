...
export function getSectionStyleDefaults(
  ...
  return {
    ...
    titleTextTransform: mergedGlobal.title?.textTransform,
    titleMobileTextTransform: undefined,
    titleLineHeight: mergedGlobal.title?.lineHeight,
    titleMobileLineHeight: undefined,
    titleLetterSpacing: mergedGlobal.title?.letterSpacing,
    ...
    subtitleTextTransform: mergedGlobal.subheading?.textTransform,
    subtitleMobileTextTransform: undefined,
    subtitleLineHeight: mergedGlobal.subheading?.lineHeight,
    subtitleMobileLineHeight: undefined,
    subtitleLetterSpacing: mergedGlobal.subheading?.letterSpacing,
    ...
    bodyTextTransform: mergedGlobal.paragraph?.textTransform,
    bodyMobileTextTransform: undefined,
    bodyLineHeight: mergedGlobal.paragraph?.lineHeight,
    bodyMobileLineHeight: undefined,
    bodyLetterSpacing: mergedGlobal.paragraph?.letterSpacing,
