...
export const DEFAULT_CUSTOM_SECTION_CONFIG: CustomSectionConfig = {
  ...
  description:
    'Create promotional sections with media, polished typography, and layout-specific content blocks.',
  layout: 'layout-1',
  bgColor: '#ffffff',
  textColor: '#0f172a',
  textAlign: 'left',
  ...
  titleFontSize: 'clamp(2.5rem, 4vw, 4rem)',
  titleFontWeight: 700,
  titleColor: '#0f172a',
  ...
  styleConfig: {
    ...
    contentSurfaceBackground: '#ffffff',
    cardBackgroundColor: '#ffffff',
    accentColor: '#7c3aed',
    mutedAccentColor: '#ede9fe',
    borderColor: '#e2e8f0',
    overlayColor: '#0f172a',
    overlayOpacity: 0.48,
    ...
    buttonBorderColor: '#d8b4fe',
    badgeBackgroundColor: '#f3e8ff',
